...
const int ID_RF0 = 0b01001000010;         // Message IDs
const int ID_RF1 = 0b01001000011;

unsigned char RF0[8] = {0, 0, 0, 0, 0, 5, 0, 5};                            // Message data
unsigned char RF1[8] = {0, 0, 0, 0, 0, 7, 0, 7};
