...
UTFR_CAN_CORNER_LF NODE(HW_PIN_CS_TEST);          // Create CAN node object
  ...
  if ((tock - tick) > data_change_interval){
      ...
      switch(change_count)
      {
        case 0:
          ...
          NODE.setField(CAN_MSG_20Hz_1, LF_20Hz_1_F, sensor_data);
        case 1:
      ...
      /*
      if (NODE.getField(CAN_MSG_20Hz_1, LF_20Hz_1_F) == 6969){
          NODE.setField(CAN_MSG_20Hz_1, LF_20Hz_1_F, 1111);
          NODE.setField(CAN_MSG_20Hz_2, LF_20Hz_2_F, 1111);
          NODE.setField(CAN_MSG_50Hz, LF_50Hz_F, 1111);
      }
      else{
          NODE.setField(CAN_MSG_20Hz_1, LF_20Hz_1_F, 6969);
          NODE.setField(CAN_MSG_20Hz_2, LF_20Hz_2_F, 6969);
          NODE.setField(CAN_MSG_50Hz, LF_50Hz_F, 6969);
      } */

      if (change_count >= log_after) {        // log mcp2515 Transmit ELFor Count (TEC) and ELFor Flags (EFLG)  
          /*
