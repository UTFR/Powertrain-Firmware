...
template <class X, class M, class N, class O, class Q>                  // See standard Arduino map() function - this shares 
X map_Generic(X x, M in_min, N in_max, O out_min, Q out_max){           // the same signature but can use floats
