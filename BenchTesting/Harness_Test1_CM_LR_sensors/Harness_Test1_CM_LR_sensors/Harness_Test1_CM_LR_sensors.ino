  ...
  if ((tock - tick) > data_change_interval){
      ...
      switch(change_count)
      {
        case 0:
          ...
          NODE.setField(CAN_MSG_20Hz_1, LR_20Hz_1_F, sensor_data);
        case 1:
      ...
      sensor_data = analogRead(HW_PIN_SENSOR_8);
      NODE.setField(CAN_MSG_20Hz_2, LR_20Hz_2_F, sensor_data);
      ...
      if (change_count >= log_after) {        // log mcp2515 Transmit ELRor Count (TEC) and ELRor Flags (EFLG)  
          /*
